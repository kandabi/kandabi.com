...
export type GenericMorph = Project | Tag | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type ProjectFiltersInput = {
  ...
  projectType?: InputMaybe<StringFilterInput>;
