...
export interface ApiProjectProject extends Schema.CollectionType {
    ...
    attributes: {
        ...
        tags: Attribute.Relation<'api::project.project', 'oneToMany', 'api::tag.tag'>;
        projectType: Attribute.Enumeration<['WEB', 'GAME', 'OTHER']> & Attribute.Required & Attribute.DefaultTo<'WEB'>;
